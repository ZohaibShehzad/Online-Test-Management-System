...
<nav class="navbar navbar-transparent navbar-absolute">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"> <?php echo $_COOKIE['name']?> </a>
    </div>
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <h4 class="card-title "><?php echo $_COOKIE['tendername']?></h4>
            <p class="category" id="card">List of All the Jobs</p>
            <form id="add-new" action="addJob.php" method="post" style="display: none">
              <div class="row">
                <div class="col-md-5">
            ...
            <div class="table-responsive" id="display">
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0"
                ...
                <tbody>
                  <?php
                  $tid = $_COOKIE['tid'];
                    $jobs = $con->get_Job_Tender($tid);
                    $num = 0;
                    while($row = array_shift($jobs)){
                      $num += 1;
                  ?>
                  <tr>
...
<script type="text/javascript">
  ...
  document.getElementById("org").classList.add("active");
</script>
