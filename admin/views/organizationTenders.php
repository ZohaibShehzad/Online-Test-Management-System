...
<nav class="navbar navbar-transparent navbar-absolute">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"> Organization Details </a>
    </div>
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <h4 class="card-title "><?php echo $_COOKIE['name']?></h4>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="date" class="date picker" name="start_date" class="form-control">
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="date" class="date picker" name="end_date" class="form-control">
                  </div>
                </div>
              </div>
              <div class="row">
            ...
            <div class="table-responsive" id="display">
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0"
                ...
                <tbody>
                  <?php
                    $oid = $_COOKIE['oid'];
                    $tenders = $con->get_Tenders_Org($oid);
                    $num = 0;
