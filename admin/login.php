...
<head>
    ...
    <title>Strategic Testing Service</title>
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0' name='viewport' />
    <meta name="viewport" content="width=device-width" />
    <!-- Canonical SEO -->
    <link rel="canonical" href="//www.strategictestingservice.com/" />
    <!--  Social tags      -->
    <meta name="keywords"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <form method="post" action="logincheck.php" id="login">
                                <div class="card card-login card-hidden">
                                    ...
                                    <div class="footer text-center">
                                        <button type="submit" form="login"
                                            class="btn btn-rose btn-simple btn-wd btn-lg">Let's go</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <footer class="footer">
                <div class="container">
                    <p class="copyright pull-right">
                        ...
                        <a href="http://www.strategictestingservice.com/">Strategic Testing Service</a>
                    </p>
                </div>
            </footer>
        </div>
